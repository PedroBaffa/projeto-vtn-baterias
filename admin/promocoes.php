        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="forms/form_promocao.php" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg">
                                ...
                                <?php foreach ($promocoes as $promo): ?>
                                    <tr>
                                        ...
                                        <td class="p-3 text-center">
                                            <a href="forms/form_promocao.php?id=<?php echo $promo['id']; ?>" class="text-blue-500 hover:text-blue-700 mx-2" title="Editar"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="actions/acoes_promocao.php?acao=deletar&id=<?php echo $promo['id']; ?>" class="text-red-500 hover:text-red-700 mx-2" title="Remover" onclick="return confirm('Tem certeza? Isso removerá a promoção de todos os produtos associados.');"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
