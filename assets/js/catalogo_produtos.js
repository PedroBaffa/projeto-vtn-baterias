...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function renderProducts(page = 1) {
        ...
        // Exibe um estado de "carregando" para o usuário.
        ...
        try {
            ...
            // Se nenhum produto for encontrado, exibe uma mensagem amigável.
            ...
            // Itera sobre cada produto recebido e cria o card HTML correspondente.
            data.products.forEach(product => {
                ...
                productCard.innerHTML = `...`; // (HTML do card)
